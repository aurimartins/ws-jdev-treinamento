			...
			<div class="main-menu-content">
				<ul>
					<li class="more-details"><a href="user-profile.html"><i
						...
						href="<%=request.getContextPath()%>/ServletLogin.java?acao=logout"><i
...
<!-- JSTL -->		<c:if test="${perfil == 'ADMIN' }"> <!--Teste realizado para verificar se usuario é ADMIN -->
						<li class=" ">
							<a href="<%= request.getContextPath()%>/ServletUsuarioController.java?acao=listarUser"class="waves-effect waves-dark"> 
								<span class="pcoded-micon">
